...
class KelasAdapter(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        return if (isFull){
            val binding =
                ItemCourseFullBinding.inflate(LayoutInflater.from(parent.context), parent, false)
            KelasFullHolder(binding)
        }else{
            val binding =
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        ...
        if (isFull){
            val viewKelasFullHolder = holder as KelasFullHolder
            viewKelasFullHolder.bindContent(data[position])
    ...
    class KelasHolder(private val binding: ItemCourseBinding) :
        ...
        fun bindContent(data: Course) {
            ...
            val percentageCompleted =
                (data.totalCompletedMaterial ?: 0) * 100 / (data.totalMaterials ?: 1)
    ...
    class KelasFullHolder(private val binding: ItemCourseFullBinding) :
        RecyclerView.ViewHolder(binding.root) {
